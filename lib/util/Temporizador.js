...
method.Iniciar = function() {
  ...
  function Init(programacion, configEncendido, configApagado, dataProvider ,logger, tcpGuests,arduino)
  {
    ...
    var x = later.setInterval(function() { Activar( programacion,dataProvider,logger,tcpGuests,arduino); }, configEncendido);
    var y = later.setInterval(function() { Desactivar(programacion, dataProvider,logger,tcpGuests,arduino); }, configApagado)
  }
  
  function Desactivar(programacion, dataProvider,logger,tcpGuests,arduino)
  {
		...
		switch (programacion.IdTipoActuador) {
			...
			case 2:
				...
				message = TipoDispositivo+Operacion+Pin+"X";
	...
	function Activar(programacion, dataProvider, logger, tcpGuests,arduino)
	{
